...
namespace Nimble.Automation.FunctionalTest
{
    ...
    class TC013_VerifyPOLOtherAnythingElseNL : TestEngine
    {
        ...
        [TestCase(1500, "android", TestName = "TC013_VerifyPOLOtherAnythingElse_NL_1500"), Category("NL"), Category("Mobile"), Retry(2)]
        [TestCase(2700, "ios", TestName = "TC013_VerifyPOLOtherAnythingElse_NL_2700")]
        public void TC013_VerifyPOLOtherAnythingElse_NL(int loanamout, string strmobiledevice)
        {
            strUserType = "NL"; 
            try
            {
                ...
                if (hideshow == true)
                {
                    ...
                    {
                        _loanPurposeDetails.RequestLoanAmountMobile(loanamout, TestData.POL.Other.Anythingelse);
                    }
                    else
                    {
                        _loanPurposeDetails.RequestLoanAmount(loanamout, TestData.POL.Other.Anythingelse);
                    }
                }
                else
                {
                    ...
                    if (GetPlatform(_driver))
                    {
                        ...
                        _loanPurposeDetails.SelectLoanPurposeMobile(TestData.POL.Other.Anythingelse);
                    }
                    else
                    {
                        // Select Purpose of loan
                        _loanPurposeDetails.SelectLoanPurpose(TestData.POL.Other.Anythingelse);
                    }
    ...
    [TestFixture, Parallelizable, Category("Milestone2"), Category("POL")]
    class TC013_VerifyPOLOtherAnythingElseRL : TestEngine
    {
        private HomeDetails _homeDetails = null;
        private LoanPurposeDetails _loanPurposeDetails = null;
        private PersonalDetails _personalDetails = null;
        ...
        [TestCase(400, "android", TestName = "TC013_VerifyPOLOtherAnythingElse_RL_400"), Category("RL"), Retry(2)]
        [TestCase(2700, "ios", TestName = "TC013_VerifyPOLOtherAnythingElse_RL_2700")]
        public void TC013_VerifyPOLOtherAnythingElse_RL(int loanamout, string strmobiledevice)
        {
            strUserType = "RL";
            try
            {
                ...
                // Select Purpose of loan
                _loanPurposeDetails.SelectLoanPurposeRL(TestData.POL.Other.Anythingelse);
