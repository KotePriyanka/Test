...
namespace Nimble.Automation.FunctionalTest
{
    ...
    class TC032_ApplyLoanwithRepaymentDateHighestNL : TestEngine
    {
        ...
        [TestCase(1000, "android", TestName = "TC032_ApplyLoanwithRepaymentDateLowest_NL_1000"), Category("NL"), Retry(2)]
        [TestCase(3250, "ios", TestName = "TC032_ApplyLoanwithRepaymentDateHighest_NL_3250")]
        public void TC032_ApplyLoanwithRepaymentDateHighest_NL(int loanamout, string strmobiledevice)
        {
            strUserType = "NL";
            ...
            try
            {
                ...
                _loanSetUpDetails.RepaymentDateHighest();

                string RepaymentDateNow = _loanSetUpDetails.GetfirstrepayFrequencyDate();

                Assert.AreNotEqual(RepaymentDateThen, RepaymentDateNow, "Repayment date unchanged even after the slider is moved to highest date");
    ...
    [TestFixture, Parallelizable, Category("Milestone2"), Category("Setup Page")]
    class TC032_ApplyLoanwithRepaymentDateHighestRL : TestEngine
    {
        private HomeDetails _homeDetails = null;
        private LoanPurposeDetails _loanPurposeDetails = null;
        private PersonalDetails _personalDetails = null;
        ...
        [TestCase(1300, "android", TestName = "TC032_ApplyLoanwithRepaymentDateHighest_RL_1300"), Category("RL"), Retry(2)]
        [TestCase(2900, "ios", TestName = "TC032_ApplyLoanwithRepaymentDateHighest_RL_2900")]
        public void TC032_ApplyLoanwithRepaymentDateHighest_RL(int loanamout, string strmobiledevice)
        {
            strUserType = "RL";
