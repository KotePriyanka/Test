...
namespace Nimble.Automation.FunctionalTest
{
    ...
    class TC027_ApplyLoanwithRepaymentAmountLowestNL : TestEngine
    {
        ...
        [TestCase(1550, "android", TestName = "TC027_ApplyLoanwithRepaymentAmountLowest_NL_1550"), Category("NL"), Retry(2)]
        [TestCase(2650, "ios", TestName = "TC027_ApplyLoanwithRepaymentAmountLowest_NL_2650")]
    ...
    [TestFixture, Parallelizable, Category("Milestone2"), Category("Setup Page")]
    class TC027_ApplyLoanwithRepaymentAmountLowestRL : TestEngine
    {
        private HomeDetails _homeDetails = null;
        private LoanPurposeDetails _loanPurposeDetails = null;
        private PersonalDetails _personalDetails = null;
        ...
        [TestCase(1550, "android", TestName = "TC027_ApplyLoanwithRepaymentAmountLowest_RL_1550"), Category("RL"), Retry(2)]
        [TestCase(2650, "ios", TestName = "TC027_ApplyLoanwithRepaymentAmountLowest_RL_2650")]
        public void TC027_ApplyLoanwithRepaymentAmountLowest_RL(int loanamout, string mobiledevice)
        {
            strUserType = "RL";
            ...
            try
            {
				...
				//int RepaymentAmountThen = _loanSetUpDetails.GetLowestRepAmt();
