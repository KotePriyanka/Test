...
namespace Nimble.Automation.FunctionalTest
{
    ...
    class TC029_ApplyLoanwithRepaymentAmountHighestNL : TestEngine
    {
        ...
        [TestCase(1550, "android", 228, TestName = "TC029_ApplyLoanwithRepaymentAmountHighest_NL_1550"), Category("NL"), Retry(2)]
        [TestCase(3650, "ios", 471, TestName = "TC029_ApplyLoanwithRepaymentAmountHighest_NL_3650")]
        public void TC029_ApplyLoanwithRepaymentAmountHighest_NL(int loanamout, string mobiledevice, int highest)
        {
            strUserType = "NL";
            ...
            try
            {
                ...
                // first repay date from pink menu
    ...
    [TestFixture, Parallelizable, Category("Milestone2"), Category("Setup Page")]
    class TC029_ApplyLoanwithRepaymentAmountHighestRL : TestEngine
    {
        private HomeDetails _homeDetails = null;
        private LoanPurposeDetails _loanPurposeDetails = null;
        private PersonalDetails _personalDetails = null;
        ...
        [TestCase(1550, "android", 640, TestName = "TC029_ApplyLoanwithRepaymentAmountHighest_RL_1500"), Category("RL"), Retry(2)]
        [TestCase(2900, "ios", 1120, TestName = "TC029_ApplyLoanwithRepaymentAmountHighest_RL_2900")]
        public void TC029_ApplyLoanwithRepaymentAmountHighest_RL(int loanamout, string mobiledevice, int highest)
        {
            strUserType = "RL";
