...
namespace Nimble.Automation.FunctionalTest
{
    ...
    class TC011_VerifyLoanWithMultiplePOL_NL : TestEngine
    {
        ...
        [TestCase(700, "android", TestName = "TC011_VerifyWithMultiplePOL_NL_700"), Category("NL"),Category("Mobile"), Retry(2)]
        [TestCase(2650, "android", TestName = "TC011_VerifyWithMultiplePOL_NL_2650")]
        public void TC011_VerifyWithMultiplePOL_NL(int loanamout, string strmobiledevice)
        {
            strUserType = "NL";  
            try
            {
                ...
                if (hideshow == true)
                {
                    ...
                    {
                        _loanPurposeDetails.RequestLoanAmountMultiplePOLMobile(loanamout, TestData.POL.Eventcosts.Birthdayparty, TestData.POL.Households);
                    }
                    else
                    {
                        _loanPurposeDetails.RequestLoanAmountMultiplePOL(loanamout, TestData.POL.Eventcosts.Birthdayparty, TestData.POL.Households);
                    }
                }
                else
                {
                    ...
                    if (GetPlatform(_driver))
                    {
                        ...
                        _loanPurposeDetails.EnterFirstPOLAmountTxt((loanamout / 2).ToString());

                        //Select click on second purpose of loan
                        _loanPurposeDetails.ClickSelectSecondPurposeBtn();

                        // Select  Second Purpose of loan
                        _loanPurposeDetails.SelectLoanPurposeMobile(TestData.POL.EducationFees);

                        // Enter Second POL Loan Amount
                        _loanPurposeDetails.EnterSecondPOLAmountTxt((loanamout / 2).ToString());
                    }
                    else
                    {
                        // Select Purpose of loan
                        ...
                        // Select  Second Purpose of loan
                        _loanPurposeDetails.SelectLoanPurpose(TestData.POL.EducationFees);
    ...
    [TestFixture, Parallelizable, Category("Milestone2"), Category("POL")]
    class TC011_VerifyLoanWithMultiplePOL_RL : TestEngine
    {
        ...
        [TestCase(1450, "android", TestName = "TC011_VerifyWithMultiplePOL_RL_1450"), Category("RL"), Category("Mobile"), Retry(2)]
        [TestCase(2900, "android", TestName = "TC011_VerifyWithMultiplePOL_RL_2900")]
        public void TC011_VerifyWithMultiplePOL_RL(int loanamout, string strmobiledevice)
        {
             strUserType = "RL";
            try
            {
                ...
                _loanPurposeDetails.ClickandSelectFirstPOL();
                ...
                // Select  Second Purpose of loan
                _loanPurposeDetails.SelectLoanPurposeRL(TestData.POL.EducationFees);
