...
namespace Nimble.Automation.FunctionalTest
{
    ...
    class TC117_VerifyRepay_Amount_NL : TestEngine
    {
        ...
        [TestCase(1100, "android", TestName = "TC117_VerifyRepayment_Amount_NL_1100"), Category("NL"), Category("Mobile"), Retry(2)]
        [TestCase(3800, "ios", TestName = "TC117_VerifyRepayment_Amount_NL_3800")]
        public void TC117_VerifyRepayment_Amount_NL(int loanamout, string strmobiledevice)
        {
            strUserType = "NL";
            try
            {
    ...
    [TestFixture, Parallelizable, Category("Milestone4"), Category("Setup Page")]
    class TC117_VerifyRepay_Amount_RL : TestEngine
    {
        ...
        [TestCase(1000, "android", TestName = "TC117_VerifyRepayment_Amount_RL_1000"), Category("RL"), Category("Mobile"), Retry(2)]
        [TestCase(2600, "android", TestName = "TC117_VerifyRepayment_Amount_RL_2600")]
        public void TC117_VerifyRepayment_Amount_RL(int loanamout, string strmobiledevice)
        {
            strUserType = "RL";
            try
            {
                ...
                _loanSetUpDetails.ClickDetailedrepaymentSchedulebtncollapse();
