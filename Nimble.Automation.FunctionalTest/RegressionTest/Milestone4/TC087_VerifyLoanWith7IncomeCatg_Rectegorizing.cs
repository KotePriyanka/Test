...
{
    //<Summary>
    //Verifying loan application by Applying a Loan With Existing 7 Income Categories And Recategorizing them in the Your Summary Screen
    //</Summary>

    [TestFixture, Parallelizable, Category("Milestone4"), Category("Income Categories")]
    class TC087_ApplyingLoanWithExisting7IncomeCategoriesAndRectegorizingThem_NL : TestEngine
    {
        [TearDown]
        ...
        [TestCase(400, "android", TestName = "TC087_ApplyingLoanWithExisting7IncomeCategoriesAndRectegorizingThem_NL_SACC_400"), Category("NL"), Retry(2)]
        [TestCase(2700, "ios", TestName = "TC087_ApplyingLoanWithExisting7IncomeCategoriesAndRectegorizingThem_NL_MACC_2700")]
        public void TC087_ApplyingLoanWithExisting7IncomeCategoriesAndRectegorizingThm_NL(int loanamout, string strmobiledevice)
        {
            strUserType = "NL";
            try
            {
    ...
    [TestFixture, Parallelizable, Category("Milestone4"), Category("Income Categories")]
    class TC087_ApplyingLoanWithExisting7IncomeCategoriesAndRectegorizingThem_RL : TestEngine
    {
        [TearDown]
        public void Cleanup()
        {
        ...
        [TestCase(1250, "android", TestName = "TC087_ApplyingLoanWithExisting7IncomeCategoriesAndRectegorizingThem_RL_SACC_1250"), Category("RL"), Retry(2)]
        [TestCase(2750, "ios", TestName = "TC087_ApplyingLoanWithExisting7IncomeCategoriesAndRectegorizingThem_RL_MACC_2750")]
        public void TC087_ApplyingLoanWithExisting7IncomeCategoriesAndRectegorizingThm_RL(int loanamout, string strmobiledevice)
        {
            strUserType = "RL";
            try
            {
