...
namespace Nimble.Automation.FunctionalTest
{
    ...
    class TC130_NoTransactionOtherAccount_NL : TestEngine
    {
        ...
        [TestCase(1500, "android", TestName = "TC130_NoTransactionOtherAccount_NL_1500"), Category("NL"), Category("Mobile"), Retry(2)]
        [TestCase(2900, "ios", TestName = "TC130_NoTransactionOtherAccount_NL_2900")]
        public void TC_130_NoTransactionOtherAccount_NL(int loanamout, string strmobiledevice)
        {
            ...
            try
            {
                ...
                bool notrans = _bankDetails.NoTransaction(TestData.NoTransactionReasons.Usinganother);
    ...
    [TestFixture, Parallelizable, Category("Milestone4"), Category("No Last 4 Day Transcations")]
    class TC130_NoTransactionOtherAccount_RL : TestEngine
    {
        private HomeDetails _homeDetails = null;
        private LoanPurposeDetails _loanPurposeDetails = null;
        private PersonalDetails _personalDetails = null;
        ...
        [TestCase(1600, "android", TestName = "TC130_NoTransactionOtherAccount_RL_1600"), Category("RL"), Retry(2)]
        [TestCase(2800, "ios", TestName = "TC130_NoTransactionOtherAccount_RL_2800")]
