...
{
    //<Summary>
    //Verifying the loan application of a user with a gambling background
    //</Summary>

    [TestFixture, Parallelizable, Category("Milestone4"), Category("Misc")]
    class TC132_VerifyGamblingDNQ_NL : TestEngine
    {
        ...
        [TestCase(1100, "android", TestName = "TC132_VerifyGamblingDNQ_NL_1100"), Category("NL"), Retry(2)]
        [TestCase(3800, "ios", TestName = "TC132_VerifyGamblingDNQ_NL_3800")]
        public void TC_132_VerifyGamblingDNQ_NL(int loanamout, string mobiledevice)
        {
            strUserType = "NL";  
            ...
            try
            {
                ...
                _bankDetails.EnterBankCredentialsTxt(TestData.BankDetails.GamblingDNQ.Yodlee.UID, TestData.BankDetails.GamblingDNQ.Yodlee.PWD);
    ...
    [TestFixture, Parallelizable, Category("Milestone4"), Category("Misc")]
    class TC132_VerifyGamblingDNQ_RL : TestEngine
    {
        private HomeDetails _homeDetails = null;
        private LoanPurposeDetails _loanPurposeDetails = null;
        private PersonalDetails _personalDetails = null;
        ...
        [TestCase(1500, "android", TestName = "TC132_VerifyGamblingDNQ_RL_1500"), Category("RL"), Retry(2)]
        [TestCase(2450, "ios", TestName = "TC132_VerifyGamblingDNQ_RL_2450")]
        public void TC_132_VerifyGamblingDNQ_RL(int loanamout, string mobiledevice)
        {
             strUserType = "RL";
