...
namespace Nimble.Automation.FunctionalTest.Milestone4
{
    ...
    class TC118_Verify_Repayment_NL : TestEngine
    {
        ...
        [TestCase(1600, "android", "$163", "$235", TestName = "TC118_Verify_Repayment_NL_1600"), Category("NL"), Retry(2)]
        [TestCase(2500, "ios", "$87", "$337", TestName = "TC118_Verify_Repayment_NL_2500")]
        public void TC118_Verify_Repay_NL(int loanamout, string strmobiledevice, string minrepay, string maxrepay)
        {
            strUserType = "NL";
    ...
    [TestFixture, Parallelizable, Category("Milestone4"), Category("Setup Page")]
    class TC118_Verify_Repayment_RL : TestEngine
    {
        private HomeDetails _homeDetails = null;
        private LoanPurposeDetails _loanPurposeDetails = null;
        private PersonalDetails _personalDetails = null;
        ...
        [TestCase(1600, "android", "$256", "$662", TestName = "TC118_Verify_Repayment_RL_1600"), Category("RL"), Retry(2)]
        [TestCase(2500, "ios", "$87", "$985", TestName = "TC118_Verify_Repayment_RL_2500")]
        public void TC118_Verify_Repay_RL(int loanamout, string strmobiledevice, string minrepay, string maxrepay)
        {
            strUserType = "RL";
