...
namespace Nimble.Automation.FunctionalTest
{
    ...
    class TC114_Employment_Temporary_NL : TestEngine
    {
        [TearDown]
        ...
        [TestCase(1600, "android", TestName = "TC114_Employment_Temporary_NL_1600"), Category("NL"), Retry(2)]
        [TestCase(2600, "android", TestName = "TC114_Employment_Temporary_NL_2600")]
        public void Employment_Temporary_NL(int loanamout, string strmobiledevice)
        {
            strUserType = "NL";  
            try
            {
                ...
                _personalDetailsData.EmploymentStatus = "Temporary";
    ...
    [TestFixture, Parallelizable, Category("Milestone4"), Category("Employment")]
    class TC114_Employment_Temporary_RL : TestEngine
    {
        [TearDown]
        public void Cleanup()
        {
        ...
        [TestCase(1100, "android", TestName = "TC114_Employment_Temporary_RL_1100"), Category("RL"), Retry(2)]
        [TestCase(2800, "android", TestName = "TC114_Employment_Temporary_RL_2800")]
        public void TTC110_Employment_Temporary_RL(int loanamout, string strmobiledevice)
        {
            strUserType = "RL";
            try
            {
                ...
                _personalDetails.SelectEmploymentStatusLst(TestData.YourEmployementStatus.Temporary);
