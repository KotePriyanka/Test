...
{
    //<Summary>
    //Verifying the text dispyed in the R&O Page when the loan is approved for MAAC and is funded for SAAC..
    //</Summary>

    [TestFixture, Parallelizable, Category("Milestone4"), Category("Misc")]
    class TC116_VerifyTextDisplay_ROpage_NL : TestEngine
    {
        [TearDown]
        ...
        [TestCase(850, "android", TestName = "TC116_VerifyTextDisplay_ROpage_NL_850"), Category("NL"), Retry(2)]
        [TestCase(2000, "android", TestName = "TC116_VerifyTextDisplay_ROpage_NL_2200")]
        public void TC116_VerifyTextDisplay_ROPage_NL(int loanamout, string strmobiledevice)
        {
            ...
            try
            {
                ...
                Assert.IsTrue(_loanSetUpDetails.FindandselectSpendless(), "R&O Page does not exist");
    ...
    [TestFixture, Parallelizable, Category("Milestone4"), Category("Misc")]
    class TC116_VerifyTextDisplay_ROpage_RL : TestEngine
    {
        [TearDown]
        public void aftermethod()
        {
        ...
        [TestCase(1300, "android", TestName = "TC116_VerifyTextDisplay_ROpage_RL_1300"), Category("RL"), Retry(2)]
        [TestCase(2000, "android", TestName = "TC116_VerifyTextDisplay_ROpage_RL_2000")]
