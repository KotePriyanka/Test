...
namespace Nimble.Automation.FunctionalTest
{
    ...
    class TC131_NoTransactionOther_NL : TestEngine
    {
        ...
        [TestCase(1500, "android", TestName = "TC131_NoTransactionOther_1500"), Category("NL"), Retry(2)]
        [TestCase(2900, "ios", TestName = "TC131_NoTransactionOther_2900")]
        public void TC_131_NoTransactionOther_NL(int loanamout, string strmobiledevice)
        {
            strUserType = "NL";
            try
            {
                ...
                bool notrans = _bankDetails.NoTransaction(TestData.NoTransactionReasons.Other);
    ...
    [TestFixture, Parallelizable, Category("Milestone4"), Category("No Last 4 Day Transcations")]
    class TC131_NoTransactionOther_RL : TestEngine
    {
        private HomeDetails _homeDetails = null;
        private LoanPurposeDetails _loanPurposeDetails = null;
        private PersonalDetails _personalDetails = null;
        ...
        [TestCase(1600, "android", TestName = "TC131_NoTransactionOther_RL_1600"), Category("RL"), Retry(2)]
        [TestCase(2800, "ios", TestName = "TC131_NoTransactionOther_RL_2800")]
