...
namespace Nimble.Automation.FunctionalTest
{
    ...
    class TC111_Employment_Casual_NL : TestEngine
    {
        [TearDown]
        ...
        [TestCase(1600, "android", TestName = "TC111_Employment_Casual_NL_1600"), Category("NL"), Category("Mobile"), Retry(2)]
        [TestCase(2600, "android", TestName = "TC111_Employment_Casual_NL_2600")]
        public void Employment_Casual_NL(int loanamout, string strmobiledevice)
        {
            strUserType = "NL";  
            try
            {
                ...
                _personalDetailsData.EmploymentStatus = "Casual";
    ...
    [TestFixture, Parallelizable, Category("Milestone4"), Category("Employment")]
    class TC111_Employment_Casual_RL : TestEngine
    {
        [TearDown]
        public void Cleanup()
        {
        ...
        [TestCase(1100, "android", TestName = "TC111_Employment_Casual_RL_1100"), Category("RL"), Retry(2)]
        [TestCase(2800, "android", TestName = "TC111_Employment_Casual_RL_2800")]
        public void TC110_Employmet_Casual_RL(int loanamout, string strmobiledevice)
        {
            strUserType = "RL";
            try
            {
                ...
                _personalDetails.SelectEmploymentStatusLst(TestData.YourEmployementStatus.Casual);
