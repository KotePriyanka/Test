...
{
    //<Summary>
    //Verifying loan application by Applying a Loan With Existing 7 Income Categories And Edit Expenses in the Your Summary Screen using the Edit Income Button
    //</Summary>


    [TestFixture, Parallelizable, Category("Milestone4"), Category("Income Categories"), Category("Expenses")]
    class TC089_VerifyLoanWith7IncomeCatg_EditExp_EditIncome_NL : TestEngine
    {
        [TearDown]
        ...
        [TestCase(400, "android", TestName = "TC089_VerifyLoanWith7IncomeCatg_EditExp_EditIncome_NL_400"), Category("NL"), Category("Mobile"), Retry(2)]
        [TestCase(2700, "ios", TestName = "TC089_VerifyLoanWith7IncomeCatg_EditExp_EditIncome_NL_2700")]
        public void TC089_VerifyLoanWith7IncomeCatg_EditExp_EditIncom_NL(int loanamout, string strmobiledevice)
        {
            strUserType = "NL";  
            try
            {
    ...
    [TestFixture, Parallelizable, Category("Milestone4"), Category("Income Categories"), Category("Expenses")]
    class TC089_VerifyLoanWith7IncomeCatg_EditExp_EditIncome_RL : TestEngine
    {
        [TearDown]
        public void Cleanup()
        {
        ...
        [TestCase(1250, "android", TestName = "TC089_VerifyLoanWith7IncomeCatg_EditExp_EditIncome_RL_1250"), Category("RL"), Retry(2)]
        [TestCase(2750, "ios", TestName = "TC089_VerifyLoanWith7IncomeCatg_EditExp_EditIncome_RL_2750")]
        public void TC089_VerifyLoanWith7IncomeCatg_EditExp_EditIncom_RL(int loanamout, string strmobiledevice)
        {
            strUserType = "RL";
            try
            {
