...
namespace Nimble.Automation.FunctionalTest
{
    ...
    class TC110_Employment_PartTime_NL : TestEngine
    {
        [TearDown]
        ...
        [TestCase(1600, "android", TestName = "TC110_Employment_PartTime_NL_1600"), Category("NL"), Retry(2)]
        [TestCase(2600, "android", TestName = "TC110_Employment_PartTime_NL_2600")]
        public void Employment_PartTime_NL(int loanamout, string strmobiledevice)
        {
            strUserType = "NL";
            try
            {
                ...
                _personalDetailsData.EmploymentStatus = "Part Time";
    ...
    [TestFixture, Parallelizable, Category("Milestone4"), Category("Employment")]
    class TC110_Employment_PartTime_RL : TestEngine
    {
        [TearDown]
        public void Cleanup()
        {
        ...
        [TestCase(1100, "android", TestName = "TC110_Employment_PartTime_RL_1100"), Category("RL"), Retry(2)]
        [TestCase(2800, "android", TestName = "TC110_Employment_PartTime_RL_2800")]
        public void TTC110_Employment_PartTime_RL(int loanamout, string strmobiledevice)
        {
            ...
            try
            {
                ...
                _personalDetails.SelectEmploymentStatusLst(TestData.YourEmployementStatus.PartTime);
