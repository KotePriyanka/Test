...
namespace Nimble.Automation.FunctionalTest.Milestone4
{
    ...
    class TC126_VerifyDynamicUpdation_SetUpPage_Min_NL : TestEngine
    {
        ...
        [TestCase(1300, "android", "$132", "$191", TestName = "TC126_VerifyDynamicUpdation_SetUpPage_Min_NL_1300"), Category("NL"), Category("Mobile"), Retry(2)]
        [TestCase(4900, "ios", "$86", "$616", TestName = "TC126_VerifyDynamicUpdation_SetUpPage_Min_NL_4900")]
        public void TC126_VerifyDynamicUpdation_SetUpPg_Min_NL(int loanamout, string strmobiledevice, string minrepay, string maxrepay)
        {
            strUserType = "NL";
            ...
            try
            {
                ...
                ////Check the mim repayment amount
                //Assert.AreEqual(minrepay, _loanSetUpDetails.GetMinRepaymentAmt(), "Minium Repayment is incorrect");

                ////Check the mim repayment amount

                //Assert.AreEqual(maxrepay, _loanSetUpDetails.GetMaxRepaymentAmt(), "Maxium Repayment is incorrect");
    ...
    [TestFixture, Parallelizable, Category("Milestone4"), Category("Setup Page")]
    class TC126_VerifyDynamicUpdation_SetUpPage_Min_RL : TestEngine
    {
        private HomeDetails _homeDetails = null;
        private LoanPurposeDetails _loanPurposeDetails = null;
        private PersonalDetails _personalDetails = null;
        ...
        [TestCase(1500, "android", "$240", "$620", TestName = "TC126_VerifyDynamicUpdation_SetUpPage_Min_RL_1500"), Category("RL"), Retry(2)]
        [TestCase(2600, "ios", "$87", "$1,019", TestName = "TC126_VerifyDynamicUpdation_SetUpPage_Min_RL_2600")]
        public void TC126_VerifyDynamicUpdation_SetUpPg_Min_RL(int loanamout, string strmobiledevice, string minrepay, string maxrepay)
        {
            strUserType = "RL";
