...
namespace Nimble.Automation.FunctionalTest.Milestone4
{
    ...
    class TC123_VerifyHasSACCNo_RePayNo_UptoDateYes_NimblePay_Yes_NL : TestEngine
    {
        ...
        [TestCase(1200, "android", TestName = "TC123_VerifyHasSACCNo_RePayNo_UptoDateYes_NimblePay_Yes_NL_1200"), Category("NL"), Retry(2)]
        [TestCase(3300, "ios", TestName = "TC123_VerifyHasSACCNo_RePayNo_UptoDateYes_NimblePay_Yes_NL_3300")]
        public void TC123_VerifyingHasSACCNo_RePayNo_UptoDateYes_NimblePay_Yes_NL(int loanamout, string strmobiledevice)
        {
            strUserType = "NL"; 
            try
            {
    ...
    [TestFixture, Parallelizable, Category("Milestone4"), Category("Two or More SAAC")]
    class TC123_VerifyHasSACCNo_RePayNo_UptoDateYes_NimblePay_Yes_RL : TestEngine
    {
        private HomeDetails _homeDetails = null;
        private LoanPurposeDetails _loanPurposeDetails = null;
        private PersonalDetails _personalDetails = null;
        ...
        [TestCase(1550, "android", TestName = "TC123_VerifyHasSACCNo_RePayNo_UptoDateYes_NimblePay_Yes_RL_1550"), Category("RL"), Retry(2)]
        [TestCase(2750, "ios", TestName = "TC123_VerifyHasSACCNo_RePayNo_UptoDateYes_NimblePay_Yes_RL_2750")]
        public void TC123_VerifyingHasSACCNo_RePayNo_UptoDateYes_NimblePay_Yes_RL(int loanamout, string strmobiledevice)
        {
            strUserType = "RL";
            try
            {
