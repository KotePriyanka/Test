...
namespace Nimble.Automation.FunctionalTest.Milestone4
{
    ...
    class TC121_VerifyHasSACCYes_RePayNo_UptoDate_No_NL : TestEngine
    {
        ...
        [TestCase(1200, "android", TestName = "TC121_VerifyHasSACCYes_RePayNo_UptoDate_No_NL_1200"), Category("NL"), Retry(2)]
        [TestCase(3300, "ios", TestName = "TC121_VerifyHasSACCYes_RePayNo_UptoDate_No_NL_3300")]
        public void TC121_VerifyingHasSACCYes_RePayNo_UptoDate_No_NL(int loanamout, string strmobiledevice)
        {
            strUserType = "NL";
            try
            {
    ...
    [TestFixture, Parallelizable, Category("Milestone4"), Category("Two or More SAAC")]
    class TC121_VerifyHasSACCYes_RePayNo_UptoDate_No_RL : TestEngine
    {
        private HomeDetails _homeDetails = null;
        private LoanPurposeDetails _loanPurposeDetails = null;
        private PersonalDetails _personalDetails = null;
        ...
        [TestCase(1550, "android", TestName = "TC121_VerifyHasSACCYes_RePayNo_UptoDate_No_RL_1550"), Category("RL"), Retry(2)]
        [TestCase(2750, "ios", TestName = "TC121_VerifyHasSACCYes_RePayNo_UptoDate_No_RL_2750")]
        public void TC121_VerifyingHasSACCYes_RePayNo_UptoDate_No_RL(int loanamout, string strmobiledevice)
        {
            strUserType = "RL";
            try
            {
