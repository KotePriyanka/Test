...
{
    //<Summary>
    //Verifying loan application with bank statemt having no transaction in the last 4 days
    //</Summary>

    [TestFixture, Parallelizable, Category("Milestone4"), Category("No Last 4 Day Transcations")]
    class TC129_NoTransactionInsufficientFunds_NL : TestEngine
    {
        ...
        [TestCase(1500, "android", TestName = "TC129_NoTransactionInsufficientFunds_NL_1500"), Category("NL"), Retry(2)]
        [TestCase(2900, "ios", TestName = "TC129_NoTransactionInsufficientFunds_NL_2900")]
        public void TC_129_NoTransactionInsufficientFunds_NL(int loanamout, string strmobiledevice)
        {
            strUserType = "NL";
            try
            {
                ...
                bool notrans = _bankDetails.NoTransaction(TestData.NoTransactionReasons.Insufficient);
    ...
    [TestFixture, Parallelizable, Category("Milestone4"), Category("No Last 4 Day Transcations")]
    class TC129_NoTransactionInsufficientFunds_RL : TestEngine
    {
        private HomeDetails _homeDetails = null;
        private LoanPurposeDetails _loanPurposeDetails = null;
        private PersonalDetails _personalDetails = null;
        ...
        [TestCase(1600, "android", TestName = "TC129_NoTransactionInsufficientFunds_RL_1600"), Category("RL"), Category("Mobile"), Retry(2)]
        [TestCase(2800, "ios", TestName = "TC129_NoTransactionInsufficientFunds_RL_2800")]
        public void TC_129_NoTransactionInsufficientFunds_RL(int loanamout, string strmobiledevice)
        {
            strUserType = "RL";
            try
            {
