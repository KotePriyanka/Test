...
namespace Nimble.Automation.FunctionalTest
{
    ...
    class TC113_Employment_Contractor_NL : TestEngine
    {
        [TearDown]
        ...
        [TestCase(1600, "android", TestName = "TC113_Employment_Contractor_NL_1600"), Category("NL"), Category("Mobile"), Retry(2)]
        [TestCase(2600, "android", TestName = "TC113_Employment_Contractor_NL_2600")]
        public void Employment_Contractor_NL(int loanamout, string strmobiledevice)
        {
            strUserType = "NL";
            try
            {
                ...
                if (hideshow == true)
                {
                    ...
                    {
                        _loanPurposeDetails.RequestLoanAmountMobile(loanamout, TestData.POL.RentBondRelocation);
                    }
                    else
                    {
                        _loanPurposeDetails.RequestLoanAmount(loanamout, TestData.POL.RentBondRelocation);
                    }
                }
                else
                {
                    ...
                    if (GetPlatform(_driver))
                    {
                        ...
                        _loanPurposeDetails.SelectLoanPurposeMobile(TestData.POL.RentBondRelocation);
                    }
                    else
                    {
                        // Select Purpose of loan
                        _loanPurposeDetails.SelectLoanPurpose(TestData.POL.RentBondRelocation);
                    }
                ...
                _personalDetailsData.EmploymentStatus = "Contractor";
    ...
    [TestFixture, Parallelizable, Category("Milestone4"), Category("Employment")]
    class TC113_Employment_Contractor_RL : TestEngine
    {
        [TearDown]
        public void Cleanup()
        {
        ...
        [TestCase(1100, "android", TestName = "TC113_Employment_Contractor_RL_1100"), Category("RL"), Retry(2)]
        [TestCase(2800, "android", TestName = "TC113_Employment_Contractor_RL_2800")]
        public void TTC110_Employment_PartTime_RL(int loanamout, string strmobiledevice)
        {
            strUserType = "RL";
            try
            {
                ...
                // Select Purpose of loan
                _loanPurposeDetails.SelectLoanPurposeRL(TestData.POL.RentBondRelocation);
                ...
                _personalDetails.SelectEmploymentStatusLst(TestData.YourEmployementStatus.Contractor);
