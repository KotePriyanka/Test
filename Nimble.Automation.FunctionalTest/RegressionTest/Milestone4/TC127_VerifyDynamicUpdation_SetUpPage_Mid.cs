...
namespace Nimble.Automation.FunctionalTest.Milestone4
{
    ...
    class TC127_VerifyDynamicUpdation_SetUpPage_Mid_NL : TestEngine
    {
        ...
        [TestCase(900, "android", "$92", "$132", TestName = "TC127_VerifyDynamicUpdation_SetUpPage_Mid_NL_900"), Category("NL"), Retry(2)]
        [TestCase(3000, "ios", "$87", "$395", TestName = "TC127_VerifyDynamicUpdation_SetUpPage_Mid_NL_3000")]
        public void TC127_VerifyDynamicUpdation_SetUpPg_Mid_NL(int loanamout, string strmobiledevice, string minrepay, string maxrepay)
        {
            strUserType = "NL";  
    ...
    [TestFixture, Parallelizable, Category("Milestone4"), Category("Setup Page")]
    class TC127_VerifyDynamicUpdation_SetUpPage_Mid_RL : TestEngine
    {
        private HomeDetails _homeDetails = null;
        private LoanPurposeDetails _loanPurposeDetails = null;
        private PersonalDetails _personalDetails = null;
        ...
        [TestCase(1000, "android", "$160", "$414", TestName = "TC127_VerifyDynamicUpdation_SetUpPage_Mid_RL_1000"), Category("RL"), Category("Mobile"), Retry(2)]
        [TestCase(2100, "ios", "$86", "$849", TestName = "TC127_VerifyDynamicUpdation_SetUpPage_Mid_RL_2100")]
        public void TC127_VerifyDynamicUpdation_SetUpPg_Mid_NL(int loanamout, string strmobiledevice, string minrepay, string maxrepay)
        {
            strUserType = "RL";
