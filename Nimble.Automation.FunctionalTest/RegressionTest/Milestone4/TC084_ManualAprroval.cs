...
namespace Nimble.Automation.FunctionalTest
{
    ...
    class TC084_ManualApprovalVerification_NL : TestEngine
    {
        ...
        [TestCase(1500, "android", TestName = "TC084_ManualApprovalVerification_1500"), Category("NL"), Retry(2)]
        [TestCase(2900, "ios", TestName = "TC084_ManualApprovalVerification_2900")]
        public void TC084_VerifyManualApproval_NL(int loanamout, string strmobiledevice)
        {
            strUserType = "NL";  
            try
            {
    ...
    [TestFixture, Parallelizable, Category("Milestone4"), Category("Misc")]
    class TC084_ManualApprovalVerification_RL : TestEngine
    {
        private HomeDetails _homeDetails = null;
        private LoanPurposeDetails _loanPurposeDetails = null;
        private PersonalDetails _personalDetails = null;
        ...
        [TestCase(1600, "android", TestName = "TC084_ManualApprovalVerification_RL_1600"), Category("RL"), Retry(2)]
        [TestCase(2800, "ios", TestName = "TC084_ManualApprovalVerification_RL_2800")]
        public void TC084_VerifyManualApproval_RL(int loanamout, string strmobiledevice)
        {
             strUserType = "RL";
            try
            {
