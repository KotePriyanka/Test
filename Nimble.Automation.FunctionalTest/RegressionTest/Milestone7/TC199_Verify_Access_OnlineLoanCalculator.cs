...
namespace Nimble.Automation.FunctionalTest
{
    ...
    class TC199_Verify_Access_OnlineLoanCalculator_NL : TestEngine
    {
        [TearDown]
        ...
        [TestCase(1100, "android", TestName = "TC199_Verify_Access_OnlineLoanCalculator_NL_1100"), Category("NL"), Retry(2)]
        [TestCase(3800, "ios", TestName = "TC199_Verify_Access_OnlineLoanCalculator_NL_3800")]
        public void TC199_Verifying_Access_OnlineLoanCalculator_NL(int loanamout, string strmobiledevice)
        {
            ...
            try
            {
                ...
                _loanCalculatorDetails.RequestLoanCalculatorAmount(loanamout);

                //Click on Start application
                _homeDetails.ClickStartApplictionBtn();

                //Verify Loancalculator amount
                _loanCalculatorDetails.verifyloancalculatorselectedamount(loanamout);
    ...
    [TestFixture, Parallelizable, Category("Milestone7")]
    class TC199_Verify_Access_OnlineLoanCalculator_RL : TestEngine
    {
        [TearDown]
        public void aftermethod()
        {
        ...
        DateTime starttime { get; set; } = DateTime.Now;
        [TestCase(1000, "android", TestName = "TC199_Verify_Access_OnlineLoanCalculator_RL_1000"), Category("RL"), Retry(2)]//android
        [TestCase(2600, "ios", TestName = "TC199_Verify_Access_OnlineLoanCalculator_RL_2600")]
        public void TC199_Verifying_Access_OnlineLoanCalculator_RL(int loanamout, string strmobiledevice)
        {
            strMessage += string.Format("\r\n\t " + TestContext.CurrentContext.Test.Name + " Starts");
            strUserType = "RL";
            try
