...
namespace Nimble.Automation.FunctionalTest.RegressionTest.Milestone7
{
    ...
    class TC211_Verify_Prefail_Twice_NoMissed_Repayment : TestEngine
    {
        [TearDown]
        public void Cleanup()
        {
        ...
        [TestCase(1000, "android", TestName = "TC211_Verify_Prefail_Twice_NoMissed_Repayment_android_RL")]//, Ignore("Functionality not available"), Category("RL"), Category("Mobile"), Retry(2)]
        [TestCase(1000, "ios", TestName = "TC211_Verify_Prefail_Twice_NoMissed_Repayment_ios_RL")]
        public void TC211_Verify_Prefail_Twice_NoMissed_Repayment_RL(int loanamout, string strmobiledevice)
        {
            strUserType = "RL";
            try
            {
