...
namespace Nimble.Automation.FunctionalTest.RegressionTest.Milestone7
{
    ...
    class TC203_CSVImportTransDesc2000_NL : TestEngine
    {
        ...
        [TestCase(1200, "chrome", TestName = "TC203_CSVImportTransDesc2000_NL_1500"), Category("NL"), Ignore("Functionality not yet ready"), Retry(2)]
        [TestCase(3300, "chrome", TestName = "TC203_CSVImportTransDesc2000_NL_4500")]
        public void TC203_VerifyingCSVImportTransDesc2000_NL(int loanamout, string strmobiledevice)
        {
            try
            {
                strUserType = "NL";
                ...
                if (_driver != null)
                {
                    ...
                    _bankDetails.EnterBankCredentialsTxt(TestData.BankDetails.TransDesc2000.Yodlee.UID, TestData.BankDetails.TransDesc2000.Yodlee.PWD);
    ...
    [TestFixture, Parallelizable, Category("Milestone7"), Category("TransDesc")]
    class TC203_CSVImportTransDesc2000_RL : TestEngine
    {
        private HomeDetails _homeDetails = null;
        private LoanPurposeDetails _loanPurposeDetails = null;
        private PersonalDetails _personalDetails = null;
        ...
        [TestCase(1550, "chrome", TestName = "TC203_CSVImportTransDesc2000_RL_1500"), Category("RL"), Ignore("Functionality not yet ready"), Retry(2)]
        [TestCase(2750, "chrome", TestName = "TC203_CSVImportTransDesc2000_RL_4500")]
        public void TC203_VerifyingCSVImportTransDesc2000_RL(int loanamout, string strmobiledevice)
        {
