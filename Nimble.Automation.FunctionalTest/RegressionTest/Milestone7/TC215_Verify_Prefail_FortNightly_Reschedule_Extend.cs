...
namespace Nimble.Automation.FunctionalTest.RegressionTest.Milestone7
{
    ...
    class TC215_Verify_Prefail_FortNightly_Reschedule_Extend : TestEngine
    {
        [TearDown]
        public void Cleanup()
        {
        ...
        [TestCase(1000, "android", TestName = "TC215_Verify_Prefail_FortNightly_Reschedule_Extend_android_RL")]//, Ignore("Functionality not available"), Category("RL"), Category("Mobile"), Retry(2)]
        [TestCase(1000, "ios", TestName = "TC215_Verify_Prefail_FortNightly_Reschedule_Extend_ios_RL")]
