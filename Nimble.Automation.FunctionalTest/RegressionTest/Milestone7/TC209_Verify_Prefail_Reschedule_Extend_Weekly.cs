...
namespace Nimble.Automation.FunctionalTest.RegressionTest.Milestone7
{
    ...
    class TC209_Verify_Prefail_Reschedule_Extend_Weekly : TestEngine
    {
        [TearDown]
        public void Cleanup()
        {
        ...
        [TestCase(1000, "android", TestName = "TC209_Verify_Prefail_Reschedule_Extend_android_RL")]//, Ignore("Functionality not available"), Category("RL"), Category("Mobile"), Retry(2)]
        [TestCase(1000, "ios", TestName = "TC209_Verify_Prefail_Reschedule_Extend_ios_RL")]
        public void TC209_Verify_Prefail_Reschedule_Extend_RL(int loanamout, string strmobiledevice)
        {
            strUserType = "RL";
            try
            {
