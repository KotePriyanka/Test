...
namespace Nimble.Automation.FunctionalTest.RegressionTest.Milestone7
{
    ...
    class TC201_Verify_Loanamt1000_Calculator_Duration : TestEngine
    {
        [TearDown]
        ...
        [TestCase(1000,13, "android", TestName = "TC201_Verify_Loanamt1000_Calculator_Duration_NL_1000"), Category("NL"), Category("Mobile"), Ignore("Functionality not yet ready"), Retry(2)]
        public void TC201_Verifying_Loanamt1000_Calculator_Duration_NL(int loanamout, int duration, string strmobiledevice)
        {
            ...
            try
            {
                ...
                //loan calculator duration
                _loanCalculatorDetails.DurationSliderMovement(duration);
    ...
    [TestFixture, Parallelizable, Category("Milestone7")]
    class TC201_Verify_Loanamt1000_Calculator_Duration_RL : TestEngine
    {
        [TearDown]
        public void aftermethod()
        {
        ...
        DateTime starttime { get; set; } = DateTime.Now;
        [TestCase(1000,13, "android", TestName = "TC201_Verify_Loanamt1000_Calculator_Duration_RL_1000"), Category("RL"), Ignore("Functionality not yet ready"), Retry(2)]
        public void TC201_Verifying_Loanamt1000_Calculator_Duration(int loanamout, int duration, string strmobiledevice)
        {
            strMessage += string.Format("\r\n\t " + TestContext.CurrentContext.Test.Name + " Starts");
            strUserType = "RL";
            try
