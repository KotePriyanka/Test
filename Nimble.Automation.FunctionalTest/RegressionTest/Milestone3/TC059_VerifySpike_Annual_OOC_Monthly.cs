...
namespace Nimble.Automation.FunctionalTest
{
    ...
    //OOC and spike and the corresponding user responses to Monthly and Annual bonus respectively
    //</Summary>
    [TestFixture, Parallelizable, Category("Milestone3"), Category("Income Spike & OOC")]
    class TC059_VerifySpike_Annual_OOC_Monthly_NL : TestEngine
    {
        ...
        [TestCase(800, "android",  TestName = "TC059_VerifySpike_Annual_OOC_Monthly_NL_800"), Category("NL"), Retry(2)]
        [TestCase(3800, "ios",  TestName = "TC059_VerifySpike_Annual_OOC_Monthly_NL_3800")]
        public void TC059_VerifySpik_Annual_OOC_Monthly_NL(int loanamout, string strmobiledevice)
        {
            strUserType = "NL";  
            try
            {
    ...
    /// </summary>
    [TestFixture, Parallelizable, Category("Milestone3"), Category("Income Spike & OOC")]
    class TC059_VerifySpike_Annual_OOC_Monthly_RL : TestEngine
    {
        ...
        [TestCase(850, "android", TestName = "TC059_VerifySpike_Annual_OOC_Monthly_RL_850"), Category("RL"), Retry(2)]
        [TestCase(2800, "ios", TestName = "TC059_VerifySpike_Annual_OOC_Monthly_RL_2800")]
        public void TC059_VerifySpik_Annual_OOC_Monthly_RL(int loanamout, string strmobiledevice)
        {
            strUserType = "RL";
            try
            {
