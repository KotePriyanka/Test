...
{
    //<Summary>
    //Applying the loan to trigger the Inconsistant and Spike income and verify two questions are triggered for 
    //II and spike and the corresponding user responses to 'Yes it will remain same' and Montly respectively
    //</Summary>
    [TestFixture, Parallelizable, Category("Milestone3"), Category("Income Spike & II")]
    class TC061_VerifySpike_Monthly_II_YestItWillStaySame_NL : TestEngine
    {
        ...
        [TestCase(1000, "android", TestName = "TC061_VerifySpike_Monthly_II_YestItWillStaySame_NL_1000"), Category("NL"), Category("Mobile"), Retry(2)]
        [TestCase(4000, "ios", TestName = "TC061_VerifySpike_Monthly_II_YestItWillStaySame_NL_4000")]
        public void TC061_VerifySpik_Monthly_II_YestItWillStaySame_NL(int loanamout, string strmobiledevice)
        {
            strUserType = "NL";
            try
            {
                ...
                _bankDetails.EnterBankCredentialsTxt(TestData.BankDetails.Spike_II.Yodlee.UID, TestData.BankDetails.Spike_II.Yodlee.PWD);
                ...
                Assert.AreEqual("$2,000.00", _bankDetails.GetSpikeTransactionAmountTxt());
                ...
                //Select reason
                _bankDetails.SelectReasonforSpikequestion("Monthly bonus");
    ...
    /// </summary>
    [TestFixture, Parallelizable, Category("Milestone3"), Category("Income Spike & II")]
    class TC061_VerifySpike_Monthly_II_YestItWillStaySame_RL : TestEngine
    {
        ...
        [TestCase(1050, "android", TestName = "TC061_VerifySpike_Monthly_II_YestItWillStaySame_RL_1050"), Category("RL"), Retry(2)]
        [TestCase(2950, "ios", TestName = "TC061_VerifySpike_Monthly_II_YestItWillStaySame_RL_2950")]
        public void TC061_VerifySpik_Monthly_II_YestItWillStaySame_RL(int loanamout, string strmobiledevice)
        {
            strUserType = "RL";
            try
            {
