...
{
    //<Summary>
    //Applying the loan to trigger the Decreasing and OOC income and verify two questions are triggered for 
    //OOC and DI and the corresponding user responses to Reimbursement  and 'Yes' respectively
    //</Summary>
    [TestFixture, Parallelizable, Category("Milestone3"), Category("Income II & DI")]
    class TC064_VerifyOOC_Reimbursement_DI_YestItWillStaySame_NL : TestEngine
    {
        ...
        [TestCase(1050, "android", TestName = "TC064_VerifyOOC_Reimbursement_DI_YestItWillStaySame_NL_1050"), Category("NL"), Retry(2)]
        [TestCase(4050, "ios", TestName = "TC064_VerifyOOC_Reimbursement_DI_YestItWillStaySame_NL_4050")]
        public void TC064_VerifyOOC_Reimbursement_DI_YestitWillStaySame_NL(int loanamout, string strmobiledevice)
        {
            strUserType = "NL";  
            try
            {
                ...
                _bankDetails.EnterBankCredentialsTxt(TestData.BankDetails.OOC_DI_MTH.Yodlee.UID, TestData.BankDetails.OOC_DI_MTH.Yodlee.PWD);
                ...
                //Select reason
                _bankDetails.SelectReasonforOOCquestion("Company expense reimbursement");
    ...
    /// </summary>
    [TestFixture, Parallelizable, Category("Milestone3"), Category("Income II & DI")]
    class TC064_VerifyOOC_Reimbursement_DI_YestItWillStaySame_RL : TestEngine
    {
        private HomeDetails _homeDetails = null;
        private LoanPurposeDetails _loanPurposeDetails = null;
        private PersonalDetails _personalDetails = null;
        ...
        [TestCase(1100, "android", TestName = "TC064_VerifyOOC_Reimbursement_DI_YestItWillStaySame_RL_1100"), Category("RL"), Retry(2)]
        [TestCase(2100, "ios", TestName = "TC064_VerifyOOC_Reimbursement_DI_YestItWillStaySame_RL_2100")]
        public void TC064_VerifyOOC_Reimbursement_DI_YestitWillStaySame_RL(int loanamout, string strmobiledevice)
        {
             strUserType = "RL";
            try
            {
