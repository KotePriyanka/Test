...
{
    //<Summary>
    //Verifying the loan application of a user with low income and low expenses.
    //</Summary>

    [TestFixture, Parallelizable, Category("Milestone3"), Category("DSC")]
    class TC076_VerifyLowIncome_LowIExp_NL : TestEngine
    {
        ...
        [TestCase(1100, "android", TestName = "TC076_VerifyLowIncome_LowIExp_NL_1100"), Category("NL"), Retry(2)]
        [TestCase(3800, "ios", TestName = "TC076_VerifyLowIncome_LowIExp_NL_3800")]
        public void TC076_VerifyLowIncome_LowIExpenses_NL(int loanamout, string mobiledevice)
        {
            strUserType = "NL";
    ...
    [TestFixture, Parallelizable, Category("Milestone3"), Category("DSC")]
    class TC076_VerifyLowIncome_LowIExp_RL : TestEngine
    {
        private HomeDetails _homeDetails = null;
        private LoanPurposeDetails _loanPurposeDetails = null;
        private PersonalDetails _personalDetails = null;
        ...
        [TestCase(1500, "android", TestName = "TC076_VerifyLowIncome_LowIExp_RL_1500"), Category("RL"), Category("Mobile"), Retry(2)]
        [TestCase(2450, "ios", TestName = "TC076_VerifyLowIncome_LowIExp_RL_2450")]
        public void TC076_VerifyLowIncome_LowIExpenses_RL(int loanamout, string mobiledevice)
        {
            strUserType = "RL";
