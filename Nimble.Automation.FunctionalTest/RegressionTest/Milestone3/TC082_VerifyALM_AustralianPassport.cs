...
namespace Nimble.Automation.FunctionalTest.Milestone3
{
    ...
    class TC082_VerifyALM_AustralianPassport : TestEngine
    {
        ...
        [TestCase(400, "android", TestName = "TC082_VerifyALM_AustralianPassport_AM1Accept_AML2Reject_NL_400"), Category("NL"), Retry(2)]
        [TestCase(2100, "ios", TestName = "TC082_VerifyALM_AustralianPassport_AM1Accept_AML2Reject_NL_2100")]
        public void TC082_VerifyALM_AustralianPassport_NL_AM1Accept_AML2Reject(int loanamount, string strdevice)
        {            
            ...
            try
            {
                ...
                _personalDetailsData.StreetName = "Cr:A Id:0 A2:S Bs1:P Rr:A Rr2:A Rr3:A He:A Bsp:Y Rmsrv:0.9999";
                ...
                _bankDetails.SelectIdTypeLst("Australian Passport");
                _bankDetails.EnterIdAustralianPassportNumberTxt();
                _bankDetails.SelectIdAustralianPassportCountyBirthLst("UNITED KINGDOM");
                _bankDetails.EnterIdAustralianPassportPlaceOfBirthTxt("LONDON");
                _bankDetails.EnterIdAustralianPassportSurnameAtBirthTxt("Ackerware");
                _bankDetails.EnterIdAustralianPassportSurnameAtCitizenshipTxt("Ackerware");
        ...
        [TestCase(1200, "android", TestName = "TC082_VerifyALM_AustralianPassport_AM1Reject_AML2Reject_NL_1200"), Category("RL"), Retry(2)]
        [TestCase(2200, "ios", TestName = "TC082_VerifyALM_AustralianPassport_AM1Reject_AML2Reject_NL_2200")]
        public void TC082_VerifyALM_AustralianPassport_NL_AM1Reject_AML2Reject(int loanamount, string strdevice)
        {
