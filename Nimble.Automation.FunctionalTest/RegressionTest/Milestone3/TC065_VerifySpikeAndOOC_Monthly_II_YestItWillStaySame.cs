...
namespace Nimble.Automation.FunctionalTest
{
    ...
    //OOC and II and the corresponding user responses to Monthly and II respectively
    //</Summary>
    [TestFixture, Parallelizable, Category("Milestone3"), Category("Income OOC & II")]
    class TC065_VerifySpikeAndOOC_Monthly_II_YestItWillStaySame_NL : TestEngine
    {
        ...
        [TestCase(1100, "android", TestName = "TC065_VerifySpikeAndOOC_Monthly_II_YestItWillStaySame_NL_1100"), Category("NL"), Retry(2)]
        [TestCase(4100, "ios", TestName = "TC065_VerifySpikeAndOOC_Monthly_II_YestItWillStaySame_NL_4100")]
        public void TC065_VerifySpikeAndOOC_Monthly_II_YestitWillStaySame_NL(int loanamout, string strmobiledevice)
        {
            strUserType = "NL";  
            try
            {
                ...
                _bankDetails.EnterBankCredentialsTxt(TestData.BankDetails.SpikeOOC_Same_II.Yodlee.UID, TestData.BankDetails.SpikeOOC_Same_II.Yodlee.PWD);
    ...
    /// </summary>
    [TestFixture, Parallelizable, Category("Milestone3"), Category("Income OOC & II")]
    class TC065_VerifySpikeAndOOC_Monthly_II_YestItWillStaySame_RL : TestEngine
    {
        private HomeDetails _homeDetails = null;
        private LoanPurposeDetails _loanPurposeDetails = null;
        private PersonalDetails _personalDetails = null;
        ...
        [TestCase(1150, "android", TestName = "TC065_VerifySpikeAndOOC_Monthly_II_YestItWillStaySame_RL_1150"), Category("RL"), Retry(2)]
        [TestCase(2150, "ios", TestName = "TC065_VerifySpikeAndOOC_Monthly_II_YestItWillStaySame_RL_2150")]
        public void TC065_VerifySpikeAndOOC_Monthly_II_YestitWillStaySame_RL(int loanamout, string strmobiledevice)
        {
             strUserType = "RL";
            try
            {
