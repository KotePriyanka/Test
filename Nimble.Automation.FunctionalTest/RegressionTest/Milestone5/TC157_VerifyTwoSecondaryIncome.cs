...
namespace Nimble.Automation.FunctionalTest.Milestone5
{
    ...
    class TC157_VerifyTwoSecondaryIncome : TestEngine
    {
        ...
        [TestCase(1250, "android", TestName = "TC157_VerifyTwoSecondaryIncome_NL_1250"), Category("NL"), Retry(2)]
        [TestCase(2850, "ios", TestName = "TC157_VerifyTwoSecondaryIncome_NL_2850")]
        public void TC157_VerifyTwoSecondaryIncome_NL(int loanamout, string strmobiledevice)
        {
            strUserType = "NL";  
            try
            {
    ...
    [TestFixture, Parallelizable, Category("Milestone5"), Category("Misc")]
    class TC157_VerifyTwoSecondaryIncome_RL : TestEngine
    {
        private HomeDetails _homeDetails = null;
        private LoanPurposeDetails _loanPurposeDetails = null;
        private PersonalDetails _personalDetails = null;
       ...
       [TearDown]
        ...
        [TestCase(1150, "android", TestName = "TC157_VerifyTwoSecondaryIncome_RL_1150"), Category("RL"), Category("Mobile"), Retry(2)]
        [TestCase(2950, "ios", TestName = "TC157_VerifyTwoSecondaryIncome_RL_2950")]
        public void TC157VerifyTwoSecondaryIncome_RL(int loanamout, string strmobiledevice)
        {
           strUserType = "RL";
            try
            {
