...
{
    // Your Expenses screen - No Rent - Salary Sacrifice
    ...
    // This test scenario covers selecting the option 'Salary Sacrifice'

    [TestFixture, Parallelizable, Category("Milestone5"), Category("Expenses")]
    class TC144_YourExpenses_NoRent_SalarySac_NL : TestEngine
    {
        ...
        [TestCase(900, "android", TestName = "TC144_YourExpenses_NoRent_SalarySacrifice_NL_900"), Category("NL"), Retry(2)]
        [TestCase(2300, "ios", TestName = "TC144_YourExpenses_NoRent_SalarySacrifice_NL_2300")]
        public void TC144_YourExpenses_NoRent_SalarySacrifice_NL (int loanamout, string strmobiledevice)
        {
            strUserType = "NL"; 
            try
            {
                ...
                // Your Expenses page - set rent to $0, select Salary Sacrifice as a response
                _bankDetails.SelectOtherDebtRepaymentsOptionBtn();
                _bankDetails.SelectDependantsLst(TestData.Dependents.Zero);
                _bankDetails.EnterExpenseMortgageTxt("0");
                _bankDetails.SelectExpenseNoRentLst("Salary Sacrifice");
    ...
    [TestFixture, Parallelizable, Category("Milestone5"), Category("Expenses")]
    class TC144_YourExpenses_NoRent_SalarySac_RL : TestEngine
    {
        private HomeDetails _homeDetails = null;
        private LoanPurposeDetails _loanPurposeDetails = null;
        private PersonalDetails _personalDetails = null;
        ...
        [TestCase(500, "android", TestName = "TC144_YourExpenses_NoRent_SalarySacrifice_RL_500"), Category("RL"), Retry(2)]
        [TestCase(2500, "ios", TestName = "TC144_YourExpenses_NoRent_SalarySacrifice_RL_2500")]
        public void TC144_YourExpenses_NoRent_SalarySacrifice_RL (int loanamout, string strmobiledevice)
        {
             strUserType = "RL";
