...
namespace Nimble.Automation.FunctionalTest.RegressionTest.Milestone5
{
    ...
    class TC169_Verify_Monthly_BankStatement_NL : TestEngine
    {
        ...
        [TestCase(1000, "android", TestName = "TC169_Verify_Monthly_BankStatement_NL_1000"), Category("NL"), Retry(2)]
        [TestCase(2500, "ios", TestName = "TC169_Verify_Monthly_BankStatement_NL_2500")]
        public void TC_169_Verify_Monthly_BankStatement(int loanamout, string strmobiledevice)
        {
            strUserType = "NL";  
            try
            {
                ...
                _bankDetails.EnterBankCredentialsTxt(TestData.BankDetails.Monthly.Yodlee.UID, TestData.BankDetails.Monthly.Yodlee.PWD);
    ...
    [TestFixture, Parallelizable, Category("Milestone5"), Category("Bank")]
    class TC169_Verify_Monthly_BankStatement_RL : TestEngine
    {
        private HomeDetails _homeDetails = null;
        private LoanPurposeDetails _loanPurposeDetails = null;
        private PersonalDetails _personalDetails = null;
        ...
        [TestCase(1000, "android", TestName = "TC169_Verify_Monthly_BankStatement_RL_1000"), Category("RL"), Category("Mobile"), Retry(2)]
        [TestCase(2500, "ios", TestName = "TC169_Verify_Monthly_BankStatement_RL_2500")]
        public void TC_169_Verify_Monthly_BankStatement(int loanamout, string strmobiledevice)
        {
           strUserType = "RL";
            try
            {
               ...
               // _bankDetails.SelectOtherDebtRepaymentsOptionBtn();
                ...
                //Consider feburary 
                //  _loanSetUpDetails.VerifySetUpPageDetails(31, loanamout, loanamout);

                //loan setup functionality
                _loanSetUpDetails.loanSetupFunction(loanamout,strUserType);
