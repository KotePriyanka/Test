...
{
    // Your Expenses screen - stated values - higher
    ...
    class TC139_YourExpenses_StatedValue_High_NL : TestEngine
    {
        ...
        [TestCase(700, "android", TestName = "TC139_YourExpenses_StatedValues_Higher_NL_700"), Category("NL"), Retry(2)]
        [TestCase(2300, "ios", TestName = "TC139_YourExpenses_StatedValues_Higher_NL_2300")]
        public void TC139_YourExpenses_StatedValues_NL(int loanamout, string strmobiledevice)
        {
            strUserType = "NL"; 
            try
            {
                ...
                // Your Expenses page
                _bankDetails.EnterExpenseEverydayLivingTxt("800");
                _bankDetails.EnterExpenseOtherDebtRepaymentsTxt("200");
                _bankDetails.EnterExpenseMortgageTxt("1600");
                _bankDetails.EnterExpenseLargeOngoingTxt("500");
                _bankDetails.SelectDependantsLst(TestData.Dependents.Zero);
                _bankDetails.ClickConfirmExpensesBtn();

                // Your Summary page
                Assert.IsTrue(_bankDetails.CompareSummaryLivingExpensesTxt("800.00"));
                Assert.IsTrue(_bankDetails.CompareSummaryOtherDebtTxt("200.00"));
                Assert.IsTrue(_bankDetails.CompareSummaryRentMortgageTxt("1600.00"));
                Assert.IsTrue(_bankDetails.CompareSummaryLargeOngoingBillsTxt("500.00"));
    ...
    [TestFixture, Parallelizable, Category("Milestone5"), Category("Expenses")]
    class TC139_YourExpenses_StatedValue_High_RL : TestEngine
    {
        private HomeDetails _homeDetails = null;
        private LoanPurposeDetails _loanPurposeDetails = null;
        private PersonalDetails _personalDetails = null;
        ...
        [TestCase(800, "android", TestName = "TC139_YourExpenses_StatedValues_Higher_RL_800"), Category("RL"), Retry(2)]
        [TestCase(2400, "ios", TestName = "TC139_YourExpenses_StatedValues_Higher_RL_2400")]
        public void TC139_YourExpenses_StatedValues_Higher_RL(int loanamout, string strmobiledevice)
        {
            strUserType = "RL";
