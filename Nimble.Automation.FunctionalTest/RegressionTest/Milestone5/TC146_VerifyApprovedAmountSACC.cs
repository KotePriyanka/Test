...
{
    //<Summary>
    //Verifying the loan application and verify aproved amount
    //</Summary>

    [TestFixture, Parallelizable, Category("Milestone5"), Category("Misc")]
    class TC146_VerifyApprovedAmountSACC : TestEngine
    {
        [TearDown]
        ...
        [TestCase(1600, "android", TestName = "TC146_VerifyApprovedAmountSACC_NL_1600"), Category("NL"), Retry(2)]
        [TestCase(2800, "ios", TestName = "TC146_VerifyApprovedAmountMACC_NL_2800")]
        public void TC146_VerifyingApprovedAmountSACC_NL(int loanamout, string strmobiledevice)
        {
            strUserType = "NL";
            try
            {
    ...
    [TestFixture, Parallelizable, Category("Milestone5"), Category("Misc")]
    class TC146_VerifyApprovedAmountSACC_RL : TestEngine
    {
        [TearDown]
        public void Cleanup()
        {
        ...
        [TestCase(1600, "android", TestName = "TC146_VerifyingApprovedAmountSACC_RL_1600"), Category("RL"), Retry(2)]
        [TestCase(2800, "ios", TestName = "TC146_VerifyingApprovedAmountMACC_RL_2800")]
