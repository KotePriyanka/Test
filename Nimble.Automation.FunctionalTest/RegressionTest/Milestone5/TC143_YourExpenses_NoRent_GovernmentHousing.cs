...
{
    // Your Expenses screen - No Rent - Government Housing
    ...
    // This test scenario covers selecting the option 'Government Housing'

    [TestFixture, Parallelizable, Category("Milestone5"), Category("Expenses")]
    class TC143_YourExpenses_NoRent_GovernmentHouse_NL : TestEngine
    {
        ...
        [TestCase(600, "android", TestName = "TC143_YourExpenses_NoRent_GovernmentHousing_NL_600"), Category("NL"), Retry(2)]
        [TestCase(2600, "ios", TestName = "TC143_YourExpenses_NoRent_GovernmentHousing_NL_2600")]
        public void TC143_YourExpenses_NoRent_GovernmentHousing_NL(int loanamout, string strmobiledevice)
        {
            strUserType = "NL";  
            try
            {
                ...
                // Your Expenses page - set rent to $0, select Government housing as a response
                _bankDetails.SelectOtherDebtRepaymentsOptionBtn();
                _bankDetails.SelectDependantsLst(TestData.Dependents.Zero);
                _bankDetails.EnterExpenseMortgageTxt("0");
                _bankDetails.SelectExpenseNoRentLst("Government housing");
    ...
    [TestFixture, Parallelizable, Category("Milestone5"), Category("Expenses")]
    class TC143_YourExpenses_NoRent_GovernmentHouse_RL : TestEngine
    {
        private HomeDetails _homeDetails = null;
        private LoanPurposeDetails _loanPurposeDetails = null;
        private PersonalDetails _personalDetails = null;
        ...
        [TestCase(600, "android", TestName = "TC143_YourExpenses_NoRent_GovernmentHousing_RL_600"), Category("RL"), Retry(2)]
        [TestCase(2200, "ios", TestName = "TC143_YourExpenses_NoRent_GovernmentHousing_RL_2200")]
        public void TC143_YourExpenses_NoRent_GovernmentHousing_RL(int loanamout, string strmobiledevice)
        {
             strUserType = "RL";
