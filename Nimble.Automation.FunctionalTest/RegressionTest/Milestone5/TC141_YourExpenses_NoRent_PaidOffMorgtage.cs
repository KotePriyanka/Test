...
{
    // Your Expenses screen - No Rent - Paid Off Mortgage
    // On the Your Expenses screen, if we identify $0 of rent or the user
    // states their rent/Mortgage value is $0, we will ask them to state why
    // This test scenario covers selecting the option 'Paid Off Mortgage'

    [TestFixture, Parallelizable, Category("Milestone5"), Category("Expenses")]
    class TC141_YourExpenses_NoRent_PaidMortgage_NL : TestEngine
    {
        ...
        [TestCase(900, "android", TestName = "TC141_YourExpenses_NoRent_PaidOffMortgage_NL_900"), Category("NL"), Retry(2)]
        [TestCase(2100, "ios", TestName = "TC141_YourExpenses_NoRent_PaidOffMortgage_NL_2100")]
        public void TC141_NoRentExpense_PaidOffMortgage_NL(int loanamout, string strmobiledevice)
        {
            strUserType = "NL";  
            try
            {
                ...
                // Your Expenses page - set rent to $0, select Paid off mortgate as a response
                _bankDetails.SelectOtherDebtRepaymentsOptionBtn();
                _bankDetails.SelectDependantsLst(TestData.Dependents.Zero);
                _bankDetails.EnterExpenseMortgageTxt("0");
                _bankDetails.SelectExpenseNoRentLst("Paid off mortgage");
    ...
    [TestFixture, Parallelizable, Category("Milestone5"), Category("Expenses")]
    class TC141_YourExpenses_NoRent_PaidMortgage_RL : TestEngine
    {
        private HomeDetails _homeDetails = null;
        private LoanPurposeDetails _loanPurposeDetails = null;
        private PersonalDetails _personalDetails = null;
        ...
        [TestCase(800, "android", TestName = "TC141_YourExpenses_NoRent_PaidOffMortgage_RL_800"), Category("RL"), Retry(2)]
        [TestCase(2800, "ios", TestName = "TC141_YourExpenses_NoRent_PaidOffMortgage_RL_2800")]
        public void TC141_YourExpenses_NoRent_PaidOffMortgage_RL(int loanamout, string strmobiledevice)
        {
             strUserType = "RL";
