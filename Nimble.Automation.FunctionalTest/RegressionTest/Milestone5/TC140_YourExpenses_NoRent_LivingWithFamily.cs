...
{
    // Your Expenses screen - No Rent - Living With Family
    ...
    // This test scenario covers selecting the option 'Living With Family/Friends'

    [TestFixture, Parallelizable, Category("Milestone5"), Category("Expenses")]
    class TC140_YourExpenses_NoRent_LivingFamily_NL : TestEngine
    {
        ...
        [TestCase(500, "android", TestName = "TC140_YourExpenses_NoRent_LivingWithFamily_NL_500"), Category("NL"), Retry(2)]
        [TestCase(2500, "ios", TestName = "TC140_YourExpenses_NoRent_LivingWithFamily_NL_2500")]
        public void TC140_YourExpenses_NoRent_LivingWithFamily_NL(int loanamout, string strmobiledevice)
        {
            ...
            try
            {
                ...
                // Your Expenses page - set rent to $0, select Living With Family/Friends as a response
                _bankDetails.SelectOtherDebtRepaymentsOptionBtn();
                _bankDetails.SelectDependantsLst(TestData.Dependents.Zero);
                _bankDetails.EnterExpenseMortgageTxt("0");
                _bankDetails.SelectExpenseNoRentLst("Living with a family/friend");
    ...
    [TestFixture, Parallelizable, Category("Milestone5"), Category("Expenses")]
    class TC140_YourExpenses_NoRent_LivingFamily_RL : TestEngine
    {
        private HomeDetails _homeDetails = null;
        private LoanPurposeDetails _loanPurposeDetails = null;
        private PersonalDetails _personalDetails = null;
        ...
        [TestCase(300, "android", TestName = "TC140_YourExpenses_NoRent_LivingWithFamily_RL_300"), Category("RL"), Category("Mobile"), Retry(2)]
        [TestCase(2600, "ios", TestName = "TC140_YourExpenses_NoRent_LivingWithFamily_RL_2600")]
        public void TC140_YourExpenses_NoRent_LivingWithFamily_RL(int loanamout, string strmobiledevice)
        {
             strUserType = "RL";
