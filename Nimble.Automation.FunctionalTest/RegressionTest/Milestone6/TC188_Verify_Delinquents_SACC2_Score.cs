...
{
    [TestFixture, Parallelizable, Category("Milestone6"), Category("Delinquents SACC2 Score")]
    class TC188_Verify_Delinquents_SACC2_Score : TestEngine
    {
        ...
        [TestCase(600, "android", TestName = "TC188_Verify_Delinquents_SACC2_Score_android_RL"), Category("RL"), Retry(2)]
        [TestCase(600, "ios", TestName = "TC188_Verify_Delinquents_SACC2_Score_ios_RL")]
        public void TC188_Verify_Delinquents_SACC2_Score_RL(int loanamout, string strmobiledevice)
        {
            ...
            try
            {
                ...
                _homeDetails.LoginExistingUser(TestData.RandomPassword, loanamout, TestData.ClientType.Delinquents, TestData.Feature.SACCdelinquent2);
