...
{
    [TestFixture, Parallelizable, Category("Milestone6"), Category("Delinquents SACC1 Score")]
    class TC187_Verify_Delinquents_SACC1_Score : TestEngine
    {
        ...
        [TestCase(600, "android", TestName = "TC187_Verify_Delinquents_SACC1_Score_android_RL"), Category("RL"), Category("Mobile"), Retry(2)]
        [TestCase(600, "ios", TestName = "TC187_Verify_Delinquents_SACC1_Score_ios_RL")]
        public void TC187_Verify_Delinquents_SACC1_Score_RL(int loanamout, string strmobiledevice)
        {
            ...
            try
            {
                ...
                _homeDetails.LoginExistingUser(TestData.RandomPassword, loanamout, TestData.ClientType.Delinquents, TestData.Feature.SACCdelinquent1);
