...
{
    [TestFixture, Parallelizable, Category("Milestone6"), Category("Delinquents MACC1 Score")]
    class TC190_Verify_Delinquents_MACC1_Score : TestEngine
    {
        ...
        [TestCase(1000, "android", TestName = "TC190_Verify_Delinquents_MACC1_Score_android_RL"), Category("RL"), Retry(2)]
        [TestCase(1000, "ios", TestName = "TC190_Verify_Delinquents_MACC1_Score_ios_RL")]
        public void TC190_Verify_Delinquents_MACC1_Score_RL(int loanamout, string strmobiledevice)
        {
            ...
            try
            {
                ...
                _homeDetails.LoginExistingUser(TestData.RandomPassword, loanamout, TestData.ClientType.Delinquents, TestData.Feature.MACCdelinquent1);
