...
{
    [TestFixture, Parallelizable, Category("Milestone6"), Category("Auto DNQed Client")]
    class TC196_Verify_Auto_DNQed_Client : TestEngine
    {
        ...
        [TestCase(1000, "android", TestName = "TC196_Verify_Auto_DNQed_Client_android_RL"), Category("RL"), Category("Mobile"), Retry(2)]
        [TestCase(3500, "ios", TestName = "TC196_Verify_Auto_DNQed_Client_ios_RL")]
        public void TC196_Verify_Auto_DNQed_Client_RL(int loanamout, string strmobiledevice)
        {
...

            {
                ...
                _homeDetails.LoginExistingUser(TestData.RandomPassword, loanamout, TestData.ClientType.NimbleStatus, TestData.Feature.AutoDNQ);
