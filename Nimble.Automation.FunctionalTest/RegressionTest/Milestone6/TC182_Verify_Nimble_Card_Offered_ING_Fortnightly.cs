...
{
    [TestFixture, Parallelizable, Category("Milestone6"), Category("Nimble Card Offered INZ Fortnightly")]
    class TC182_Verify_Nimble_Card_Offered_ING_Fortnightly:TestEngine
    {
        ...
        [TestCase(1500, "android", TestName = "TC182_Verify_Nimble_Card_Offered_INZ_Fortnightly_android_RL"), Category("RL"), Category("Mobile"), Retry(2)]
        [TestCase(3800, "ios", TestName = "TC182_Verify_Nimble_Card_Offered_INZ_Fortnightly_ios_RL")]
        public void TC182_Verify_Nimble_Card_Offered_INZ_Fortnightly_RL(int loanamout, string strmobiledevice)
        {
            strUserType = "RL";
            try
            {
                ...
                _homeDetails.LoginExistingUser(TestData.RandomPassword, loanamout, TestData.ClientType.NimbleCardEligibility, TestData.Feature.INGactivefortnightlycardoffered);
