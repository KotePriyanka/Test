...
namespace Nimble.Automation.FunctionalTest.RegressionTest.Milestone6
{
    ...
    class TC183_Verify_Nimble_Card_Offered_ING_Monthly : TestEngine
    {
        ...
        [TestCase(1500, "android", TestName = "TC183_Verify_Nimble_Card_Offered_INZ_Monthly_android_RL"), Category("RL"), Retry(2)]
        [TestCase(3800, "ios", TestName = "TC183_Verify_Nimble_Card_Offered_INZ_Monthly_ios_RL")]
