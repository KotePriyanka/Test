...
{
    [TestFixture, Parallelizable, Category("Milestone6"), Category("Nimble Card Offered Pre Eligibility ANZ")]
    class TC179_Verify_Nimble_Card_Offered_PreEligibility_ANZ : TestEngine
    {
        ...
        [TestCase(1500, "android", TestName = "TC179_Verify_Nimble_Card_Offered_PreEligibility_ANZ_android_RL"), Category("RL"), Category("Mobile"), Retry(2)]
        [TestCase(3800, "ios", TestName = "TC179_Verify_Nimble_Card_Offered_PreEligibility_ANZ_ios_RL")]
        public void TC179_Verify_Nimble_Card_Offered_PreEligibility_ANZ_RL(int loanamout, string strmobiledevice)
        {
            strUserType = "RL";
            try
            {
                ...
                _homeDetails.LoginExistingUser(TestData.RandomPassword, loanamout, TestData.ClientType.NimbleCardEligibility, TestData.Feature.ANZactivecardofferedpreEligibility);
