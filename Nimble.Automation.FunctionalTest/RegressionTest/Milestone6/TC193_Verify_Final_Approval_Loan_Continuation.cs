...
{
    [TestFixture, Parallelizable, Category("Milestone6"), Category("Final Approval Loan Continuation")]
    class TC193_Verify_Final_Approval_Loan_Continuation : TestEngine
    {
        ...
        [TestCase(1800, "android", TestName = "TC193_Verify_Final_Approval_Loan_Continuation_android_RL"), Category("RL"), Retry(2)]
        [TestCase(3500, "ios", TestName = "TC193_Verify_Final_Approval_Loan_Continuation_ios_RL")]
        public void TC191_Verify_Delinquents_MACC2_Score_RL(int loanamout, string strmobiledevice)
        {
            ...
            try
            {
                ...
                _homeDetails.LoginExistingUser(TestData.RandomPassword, loanamout, TestData.ClientType.NimbleStatus, TestData.Feature.FinalApproval);            
