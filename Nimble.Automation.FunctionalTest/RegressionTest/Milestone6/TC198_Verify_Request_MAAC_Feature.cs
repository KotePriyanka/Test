...
{
    [TestFixture, Parallelizable, Category("Milestone6"), Category("Requested MACC Feature")]
    class TC198_Verify_Request_MAAc_Feature : TestEngine
    {
        ...
        [TestCase(4900, "android", TestName = "TC198_Verify_Request_MAAC_Feature_android_RL"), Category("RL"), Retry(2)]
        [TestCase(5000, "ios", TestName = "TC198_Verify_Request_MAAC_Feature_ios_RL")]
        public void TC198_Verifying_Request_MAAC_Feature_RL(int loanamout, string strmobiledevice)
        {
