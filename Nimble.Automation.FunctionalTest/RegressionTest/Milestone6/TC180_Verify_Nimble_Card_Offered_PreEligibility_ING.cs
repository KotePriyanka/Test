...
{
    [TestFixture, Parallelizable, Category("Milestone6"), Category("Nimble Card Offered Pre Eligibility INZ")]
    class TC180_Verify_Nimble_Card_Offered_PreEligibility_ING : TestEngine
    {
        ...
        [TestCase(1500, "android", TestName = "TC180_Verify_Nimble_Card_Offered_PreEligibility_INZ_android_RL"), Category("RL"), Category("Mobile"), Retry(2)]
        [TestCase(3800, "ios", TestName = "TC180_Verify_Nimble_Card_Offered_PreEligibility_INZ_ios_RL")]
        public void TC180_Verify_Nimble_Card_Offered_PreEligibility_INZ_RL(int loanamout, string strmobiledevice)
        {
            strUserType = "RL";
            try
            {
                ...
                _homeDetails.LoginExistingUser(TestData.RandomPassword, loanamout, TestData.ClientType.NimbleCardEligibility, TestData.Feature.INGactivecardofferedpreEligibility);
