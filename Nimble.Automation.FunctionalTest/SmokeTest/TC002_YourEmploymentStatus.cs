...
namespace Nimble.Automation.FunctionalTest
{
    ...
    class TC002_YourEmploymentStatus_NL : TestEngine
    {
        [TearDown]
        ...
        [TestCase(1600, "android", TestName = "TC002_EmploymentStatus_NL_1600"), Category("NL"), Category("Mobile"), Retry(2)]//android
        [TestCase(2600, "ios", TestName = "TC002_EmploymentStatus_NL_2600")]
        public void TC002_EmploymentStatus_NL(int loanamout, string strmobiledevice)
        {
    ...
    [TestFixture, Parallelizable, Category("SmokeTest")]
    class TC002_YourEmploymentStatus_RL : TestEngine
    {
        ...
        [TestCase(1100, "android", TestName = "TC002_EmploymentStatus_RL_1100"), Category("RL"), Category("Mobile"), Retry(2)]
        [TestCase(2800, "ios", TestName = "TC002_EmploymentStatus_RL_2800")]
        public void TC002_EmploymentStatus_RL(int loanamout, string strmobiledevice)
        {
            strMessage += string.Format("\r\n\t " + TestContext.CurrentContext.Test.Name + " Starts");
            strUserType = "RL";
            try
