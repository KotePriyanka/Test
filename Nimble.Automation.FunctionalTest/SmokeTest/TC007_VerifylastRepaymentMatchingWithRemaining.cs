...
namespace Nimble.Automation.FunctionalTest
{
    ...
    class TC007_VerifylastRepaymentMatchingWithRemaining_NL : TestEngine
    {
        [TearDown]
        ...
        [TestCase(1400, "android", TestName = "TC007_VerifylastRepaymentMatchingWithRemaining_NL_1400"), Category("NL"), Category("Mobile"), Retry(2)]
        [TestCase(3900, "ios", TestName = "TC007_VerifylastRepaymentMatchingWithRemaining_NL_3900")]
        public void TC007_lastRepaymentMatchingWithRemaining_NL(int loanamout, string strmobiledevice)
        {
            strUserType = "NL";
            try
            {
                ...
                if (hideshow == true)
                {
                    ...
                    {
                        _loanPurposeDetails.RequestLoanAmountMobile(loanamout, TestData.POL.MedicalDentalexpenses);
                    }
                    else
                    {
                        _loanPurposeDetails.RequestLoanAmount(loanamout, TestData.POL.MedicalDentalexpenses);
                    }
                }
                else
                {
                    ...
                    if (GetPlatform(_driver))
                    {
                        ...
                        _loanPurposeDetails.SelectLoanPurposeMobile(TestData.POL.MedicalDentalexpenses);
                    }
                    else
                    {
                        // Select Purpose of loan
                        _loanPurposeDetails.SelectLoanPurpose(TestData.POL.MedicalDentalexpenses);
                    }
                ...
                if (GetPlatform(_driver))
                {
                    ...
                    // Verify the Repay amount
                    _loanSetUpDetails.VerifyRepayAmount();
    ...
    [TestFixture, Parallelizable, Category("SmokeTest")]
    class TC007_VerifylastRepaymentMatchingWithRemaining_RL : TestEngine
    {
        [TearDown]
        public void aftermethod()
        {
        ...
        [TestCase(950, 950, "android", TestName = "TC007_VerifylastRepaymentMatchingWithRemaining_RL_600"), Category("RL"), Category("Mobile"), Retry(2)]
        [TestCase(3600, 3600, "ios", TestName = "TC007_VerifylastRepaymentMatchingWithRemaining_RL_3600")]
        public void TC007_lastRepaymentMatchingWithRemaining_RL(int loanamout, int approvedamt, string strmobiledevice)
        {
            strUserType = "RL";
            try
            {
                ...
                // Select Purpose of loan
                _loanPurposeDetails.SelectLoanPurposeRL(TestData.POL.MedicalDentalexpenses);
