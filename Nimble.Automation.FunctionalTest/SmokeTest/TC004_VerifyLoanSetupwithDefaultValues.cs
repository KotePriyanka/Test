...
namespace Nimble.Automation.FunctionalTest.SmokeTest
{
    ...
    class TC004_VerifyLoanSetupwithDefaultValues_NL : TestEngine
    {
        [TearDown]
        ...
        [TestCase(1550, "android", TestName = "TC004_LoanSetupWithDefaultValues_NL_1550"), Category("NL"), Category("Mobile"), Retry(2)]
        [TestCase(2750, "ios", TestName = "TC004_LoanSetupWithDefaultValues_NL_2750")]
        public void TC004_LoanSetupWithDefaultValues_NL(int loanamout, string strmobiledevice)
        {
            strUserType = "NL";
            try
            {
    ...
    [TestFixture, Parallelizable, Category("SmokeTest")]
    class TC004_VerifyLoanSetupwithDefaultValues_RL : TestEngine
    {
        ...
        [TestCase(1350, "android", TestName = "TC004_LoanSetupWithDefaultValues_RL_1350"), Category("RL"), Category("Mobile"), Retry(2)]
        [TestCase(2950, "ios", TestName = "TC004_LoanSetupWithDefaultValues_RL_2950")]
        public void TC004_LoanSetupWithDefaultValues_RL(int loanamout, string strmobiledevice)
        {
            strUserType = "RL";
            try
            {
                ...
                // Select Purpose of loan
                _loanPurposeDetails.SelectLoanPurposeRL(TestData.POL.TravelHoliday.Airline);
