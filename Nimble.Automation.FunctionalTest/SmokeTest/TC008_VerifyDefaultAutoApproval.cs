...
namespace Nimble.Automation.FunctionalTest.SmokeTest
{
    [TestFixture, Parallelizable, Category("SmokeTest")]
    class TC008_VerifyDefaultAutoApproval_NL : TestEngine
    {
        [TearDown]
        ...
        [TestCase(1550, "android", TestName = "TC008_VerifyAutoApproval_NL_1550"), Category("NL"), Category("Mobile"), Retry(2)]
        [TestCase(3300, "ios", TestName = "TC008_VerifyAutoApproval_NL_3300")]
        public void TC008_AutoApproval_NL(int loanamout, string strmobiledevice)
        {
            strUserType = "NL";
            try
            {
                ...
                if (hideshow == true)
                {
                    ...
                    {
                        _loanPurposeDetails.RequestLoanAmountMobile(loanamout, TestData.POL.EducationFees);
                    }
                    else
                    {
                        _loanPurposeDetails.RequestLoanAmount(loanamout, TestData.POL.EducationFees);
                    }
                }
                else
                {
    ...
    [TestFixture, Parallelizable, Category("SmokeTest")]
    class TC008_VerifyDefaultAutoApproval_RL : TestEngine
    {
        [TearDown]
        public void aftermethod()
        {
        ...
        [TestCase(1000, 1000, "android", TestName = "TC008_VerifyAutoApproval_RL_1000"), Category("RL"), Category("Mobile"), Retry(2)]
        [TestCase(4500, 4500, "ios", TestName = "TC008_VerifyAutoApproval_RL_4500")]
        public void TC008_AutoApproval_RL(int loanamout, int approvedamt, string strmobiledevice)
        {
            strUserType = "RL";
            try
            {
